...
let userID = 'be92d763-5e9e-495e-8c76-bf251480688e';
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        url.hostname = 'gspe79-ssl.ls.apple.com';
                        url.protocol = 'https:';
...
const buildDNSObject = async (remoteDNS, localDNS, blockAds, bypassIran, blockPorn, isWorkerLess) => {
    ...
    if (isWorkerLess) {
        ...
        const resolvedCLDomain = await resolveDNS('gspe79-ssl.ls.apple.com.cdn.cloudflare.net');
